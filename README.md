# Project 3 - SelinaTwitterApp

SelinaTwitterApp is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
Other Extras:
* [x] Delete on long click on an item

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/TA3GnfA.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
